  ...
  <div>
    <div class="big_screen">
      ...
      <div class="drag_upload">
        ...
        <label>Doctor Diagnosis Result
        <br>(0=Low, 1=Medium, 2=High)
        </label>
        </div>
        <input v-model="level" placeholder="Please enter" >
    ...
    predict(val) {
      ...
      axios.post(path, val)
        .then((response) => {
          ...
          const message = `Our AI suggests the patient's possibility of getting lung cancer is
